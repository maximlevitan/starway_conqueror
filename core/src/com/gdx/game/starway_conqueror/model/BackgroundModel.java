...
public class BackgroundModel {
    private class Star {
        ...
        public Star() {
            this.position = new Vector2((float) Math.random() * ApplicationController.SCREEN_WIDTH, (float) Math.random() * ApplicationController.SCREEN_HEIGHT);
    ...
    public BackgroundModel(TextureRegion textureStar) {
